...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/azure-keyvault-secrets-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10806&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/azure-keyvault-secrets-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `azure-keyvault-secrets` can be installed with:

```
conda install azure-keyvault-secrets
```

It is possible to list all of the versions of `azure-keyvault-secrets` available on your platform with:
